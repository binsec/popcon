...
(define-fun
nxt_r3_124_bv_bnop_2_bv_unop_1 () (_ BitVec 32)
((_ zero_extend 16) ((_ extract 63 48) packet_8)))
(define-fun
nxt_r3_124_bv_bnop_2_bv_unop_3 () (_ BitVec 32)
((_ zero_extend 16) ((_ extract 15 0) packet_8)))
(define-fun
nxt_r3_124_bv_bnop_2_bv_unop_5 () (_ BitVec 32)
((_ zero_extend 16) ((_ extract 31 16) packet_8)))
(define-fun
nxt_r3_124_bv_bnop_2_bv_unop_7 () (_ BitVec 32)
((_ zero_extend 16) ((_ extract 47 32) packet_8)))
(define-fun
nxt_r3_124 () (_ BitVec 32)
(bvand
(bvadd
(bvadd (bvadd nxt_r3_124_bv_bnop_2_bv_unop_1 nxt_r3_124_bv_bnop_2_bv_unop_3)
nxt_r3_124_bv_bnop_2_bv_unop_5) nxt_r3_124_bv_bnop_2_bv_unop_7) nxt_r0_122))
(declare-fun target_checksum_134 ()
(_ BitVec 32))
(define-fun
...
(bvadd
(bvadd (bvadd nxt_r3_124_bv_bnop_2_bv_unop_1 nxt_r3_124_bv_bnop_2_bv_unop_3)
nxt_r3_124_bv_bnop_2_bv_unop_5) nxt_r3_124_bv_bnop_2_bv_unop_7) (_ bv16 32)))
(assert
(=
(bvand nxt_r0_122
(bvnot
(bvadd
(bvadd nxt_r3_124 (bvashr (bvadd nxt_r3_124 assert_bv_bnop_0) (_ bv16 32)))
assert_bv_bnop_0))) target_checksum_134))