...
(define-fun
__memory_11_bv_unop_0 () (_ BitVec 32) ((_ zero_extend 8) cardpin_low_7))
...
(define-fun
assert_bv_unop_12 () (_ BitVec 8) ((_ extract 23 16) userpin_9))
(define-fun
assert_bv_unop_13 () (_ BitVec 8) ((_ extract 15 8) userpin_9))
(define-fun
assert_bv_unop_15 () (_ BitVec 8) ((_ extract 23 16) __memory_11_bv_unop_0))
(define-fun
assert_bv_unop_16 () (_ BitVec 8) ((_ extract 15 8) __memory_11_bv_unop_0))
(define-fun
assert_bv_unop_17 () (_ BitVec 8) ((_ extract 7 0) __memory_11_bv_unop_0))
(assert
...
(ite (= nxt_r3_51 (_ bv10345 32)) assert_bv_unop_12
...
(ite (= nxt_r3_51 (_ bv10349 32)) assert_bv_unop_15
...
(ite (= nxt_r3_51 (_ bv10344 32)) assert_bv_unop_12
...
(ite (= nxt_r3_51 (_ bv10348 32)) assert_bv_unop_15
...
(ite (= (bvadd nxt_r3_51 (_ bv1 32)) nxt_r3_51) __array_symbolic___memory_3_2
...
(ite (= nxt_r3_51 (_ bv10343 32)) assert_bv_unop_12
...
(ite (= nxt_r3_51 (_ bv10347 32)) assert_bv_unop_15
...
(ite (= (bvadd nxt_r3_51 (_ bv2 32)) nxt_r3_51) __array_symbolic___memory_3_2
(ite (= (bvadd nxt_r3_51 (_ bv2 32)) (bvadd nxt_r3_51 (_ bv1 32)))
__array_symbolic___memory_3_3
(ite (= (bvadd nxt_r3_51 (_ bv2 32)) (bvadd nxt_r3_51 (_ bv3 32)))
...
(ite (= nxt_r3_51 (_ bv10342 32)) assert_bv_unop_12
...
(ite (= nxt_r3_51 (_ bv10346 32)) assert_bv_unop_15
...
(ite (= (bvadd nxt_r3_51 (_ bv3 32)) nxt_r3_51) __array_symbolic___memory_3_2
(ite (= (bvadd nxt_r3_51 (_ bv3 32)) (bvadd nxt_r3_51 (_ bv1 32)))
__array_symbolic___memory_3_3 __array_symbolic___memory_3_4)))))))))))))))
(_ bv0 32)))